...
Route::group(['middleware' => ['ValidUser']], function () {
    ...
    Route::delete('/trashcategory/forcedelete/{id}',[CategoryController::class,'forcedelete'])->name('forcedelete.category');
    ...
    Route::delete('/trashmenu/forcedelete/{id}',[MenuController::class,'forcedelete'])->name('forcedelete.menu');
    ...
    Route::delete('trashstaff/forcedelete/{id}',[StaffController::class,'forcedelete'])->name('forcedelete.staff');
    ...
    Route::delete('trashtable/forcedelete/{id}',[TableController::class,'forcedelete'])->name('forcedelete.table');
